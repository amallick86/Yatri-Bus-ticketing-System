...
<head>
  ...
  <title> <?php echo $row["user_fname"];?> - Ticket </title>
  <!-- Font Awesome -->
	...
	<div class="ticket">
		<form>
			...
			<table id="table">
				<tr>
					<td>Phone</td>
					<td><input type="text"  name="" id="phone" value="<?php echo $row["user_phn"];?>" readonly></td>
				</tr>
				<tr>
					<td>Name</td>
			...
			<li class="nav-item dropdown d-lg-flex d-none" >
                  <button id="home" type="button" class="btn btn-inverse-primary btn-sm" onclick="window.location.href='user_dash.php'">HOME</button>
                </li>
				<li class="nav-item dropdown d-lg-flex d-none" >
                  <button id="pdf"type="button" class="btn btn-inverse-primary btn-sm" onclick="window.location.href='pdf.php?date=<?php echo $bus_date?> & seat=<?php echo $seat?>'">PRINT <i class="fa fa-file-text fa-spin" aria-hidden="true"></i><span class="sr-only">Loading...</span></button>
                </li>
		</form>
	</div>
