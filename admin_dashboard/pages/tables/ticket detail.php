...
//Retrieve Date
    ...
    $sql="select * from bus_detail where cmp_name='$bus_name' ORDER BY bus_id desc";
	$result1 = mysqli_query($cser, $sql) or die ( mysqli_error());
	
	$query2 = "SELECT * from bus_seats where cmp_name='$bus_name' and status = '1'  ORDER BY seat_id desc"; 
					$result2 = mysqli_query($cser, $query2) or die ( mysqli_error());
        ...
        while ($row2 = mysqli_fetch_assoc($result2)) {?>
                      <tbody>
                        <tr>
                          ...
                          <td>
                           <?php echo $row2["seat_date"];?>
                          </td>
						  <td>
                           <?php echo $row2["cmp_name"];?>
                          </td>
                          <td>
                            <?php echo $row2["bus_num"];?>
                          </td>
                          <td>
                            <?php echo $row2["seat_id"];?>
                          </td>
                          <td>
                            <?php echo $row2["seat_num"];?>
                          </td>
						  <td>
                           <?php echo $row2["seat_name"];?>
                          </td>
						  <td>
                            <?php echo $row2["bus_from"];?>
                          </td>
						  <td>
                            <?php echo $row2["bus_to"];?>
                          </td>
						  <td>
							...
							$sdate=$row2["seat_date"];
							$status=$row2["status"];
							if($currentDateTime < $sdate & $status == 1){
							echo "UpComing";}
							elseif($currentDateTime == $sdate & $status == 1){
							echo "Today";}
							else{
							echo "checked";}?>
                          </td>
						  <td>
						  Rs <?php echo $row2["total_price"]; ?>
						  </td>
						  <td>
						  <center><a href="../../../admin_pdf.php?date=<?php echo $row2["seat_date"];?> & seat=<?php echo $row2["seat_name"];?>"><i class="fa fa-download fa-lg" aria-hidden="true"></i></a>
						 </center> </td>
                        </tr>
