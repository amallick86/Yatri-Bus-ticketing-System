...
//Retrieve ticket
	...
	$query2 = "SELECT * from bus_seats where cmp_name='$bus_name' and status = '1' and seat_date='$currentDateTime'  ORDER BY seat_id desc"; 
              ...
              <div class="card">
                <div class="card-body">
                  <h4 class="card-title"><center><?php $currentDateTime = date("Y-m-d");
						echo $currentDateTime;?> Ticket Details </center></h4>
