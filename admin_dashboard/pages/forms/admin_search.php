...
<head>
  ...
  <title><?php echo $row["cmp_name"];?> - Search</title>
  <!-- base:css -->
...
if(isset($_POST["bus_search"]))
    ...
    $sql="select * from bus_detail where cmp_name='$bus_name' and bus_from='$busfrom' and bus_to='$busto' and bus_date='$busdate' ";
	...
	$Sno=1;
        while ($row1 = mysqli_fetch_assoc($bus)) {?>
					...
					if($count==36)
						...
						{echo "<a  href='../../../admin_seat.php?busnumber=$busnum & dateofbus=$busd'
...
<?php 				 
	...
	$buspto=$_POST["buspto"];
	$bus_name =  $row["cmp_name"];
    $sql="select * from bus_detail where cmp_name='$bus_name' and bus_from='$buspfrom' and bus_to='$buspto' ";
