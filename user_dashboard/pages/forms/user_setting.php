...
<head>
  ...
  <title><?php echo $row["user_fname"];?> - Settings</title>
  <!-- base:css -->
                ...
                <div class="card-body">
				  ...
				  <?php
					...
					. ")");
						...
						<?php if (isset($_POST['user_update'])){
							 $user_pass= $_POST['user_pass'];
							 $user_pass= md5($user_pass);
							 $user_cpass= $_POST['user_cpass'];
						// Attempt update query execution
						$sql = "UPDATE user_account SET user_pass='$user_pass', user_cpass='$user_cpass' WHERE user_id='$user_id'";
                  ...
                  <div class="form-group">
                    ...
                    <div class="input-group mb-2 mr-sm-2">
                      ...
                      <input  class="form-control" value="<?php echo $row["user_uname"];?>" readonly >
                    </div>
                  </div>
                   <div class="form-group">
				  ...
				  <div class="form-group">
                      ...
                      <input type="password" class="form-control" name="user_cpass" required="">
                    </div>
				  <button class="btn btn-primary mb-2" name="user_update">Update</button>
				  </form>
                </div>
              </div>
            </div>
